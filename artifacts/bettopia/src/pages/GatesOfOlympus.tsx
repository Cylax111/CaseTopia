...
export default function GatesOfOlympus() {
  ...
  const DEMO_URL =
    "https://demogamesfree.pragmaticplay.net/gs2c/openGame.do?gameSymbol=vs20olympgate&lang=en&cur=USD&jurisdiction=MT";
  ...
  async function launchReal() {
    ...
    try {
      ...
      const res = await fetch("/api/games/pp-launch", {
        ...
        body: JSON.stringify({ gameSymbol: "vs20olympgate" }),
      });
      if (!res.ok) {
