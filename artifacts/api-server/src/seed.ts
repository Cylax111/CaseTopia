...
const OFFICIAL_CASES = [
  ...
  {
    name: "Case Of Hell",
    imageUrl: "chest:#E11D48|/api/assets/hellfire_horns_-_ruby_1775542103716.webp",
    price: 143.5734,
    category: "official",
    isCommunity: false,
    createdById: 1,
    createdByName: "Cylax",
    items: [
      { id: "ruby_block",                   name: "Ruby Block",                        color: "#e53935", value: 1,     chance: 58.4,  rarity: "common",    imageUrl: "/api/assets/ruby_block_1775540427818.webp" },
      { id: "fire_wand",                     name: "Fire Wand",                         color: "#ef4444", value: 30,    chance: 20,    rarity: "rare",      imageUrl: "/api/assets/fire_wand_1775671807243.webp" },
      { id: "devil_wings",                   name: "Devil Wings",                       color: "#c62828", value: 70,    chance: 10,    rarity: "epic",      imageUrl: "/api/assets/devil_wings_1775542503117.webp" },
      { id: "phoenix_mantle",                name: "Phoenix Mantle",                    color: "#ef6c00", value: 250,   chance: 5,     rarity: "epic",      imageUrl: "/api/assets/p_mantle_1775542738537.webp" },
      { id: "phoenix_sword",                 name: "Phoenix Sword",                     color: "#ef5350", value: 550,   chance: 3,     rarity: "mythic",    imageUrl: "/api/assets/p_sword_1775619879406.webp" },
      { id: "curse_wand",                    name: "Curse Wand",                        color: "#7c3aed", value: 1200,  chance: 1.5,   rarity: "mythic",    imageUrl: "/api/assets/curse_wand_1775671817776.webp" },
      { id: "freakrs_tormented_grasp",       name: "FrEAkR's Tormented Grasp",         color: "#dc2626", value: 1450,  chance: 1.25,  rarity: "mythic",    imageUrl: "/api/assets/freakr_1775672567359.webp" },
      { id: "dragon_of_legend",              name: "Dragon Of Legend",                  color: "#9c27b0", value: 3000,  chance: 0.5,   rarity: "legendary", imageUrl: "/api/assets/l_drag_1775619570342.webp" },
      { id: "legendary_dragon_knights_wings",name: "Legendary Dragon Knight's Wings",   color: "#dc2626", value: 6500,  chance: 0.25,  rarity: "legendary", imageUrl: "/api/assets/l_drag_wings_1775672007290.webp" },
      { id: "hellfire_horns_ruby",           name: "Hellfire Horns - Ruby",             color: "#b71c1c", value: 25000, chance: 0.1,   rarity: "legendary", imageUrl: "/api/assets/hellfire_horns_-_ruby_1775542103716.webp" },
    ],
  },
  {
    name: "Fly Away",
    imageUrl: "chest:#475569|/api/assets/l_wings_1775671916613.webp",
    price: 59.012,
    category: "official",
    isCommunity: false,
    createdById: 1,
    createdByName: "Cylax",
    items: [
      { id: "fairy_wings",                   name: "Fairy Wings",                       color: "#f0abfc", value: 0.03,  chance: 30,    rarity: "uncommon",  imageUrl: "/api/assets/fairy_wings_1775747502366.webp" },
      { id: "teeny_angel_wings",             name: "Teeny Angel Wings",                 color: "#e0e0e0", value: 0.05,  chance: 24.6,  rarity: "rare",      imageUrl: "/api/assets/teeny_angel_wings_1775747483643.webp" },
      { id: "chimera_wings",                 name: "Chimera Wings",                     color: "#1e88e5", value: 7,     chance: 10,    rarity: "epic",      imageUrl: "/api/assets/Chimera_1775542535003.webp" },
      { id: "autumn_wings",                  name: "Autumn Wings",                      color: "#f97316", value: 9,     chance: 5,     rarity: "epic",      imageUrl: "/api/assets/autumn_wings_1775747655581.webp" },
      { id: "rainbow_wings",                 name: "Rainbow Wings",                     color: "#f472b6", value: 10,    chance: 5,     rarity: "epic",      imageUrl: "/api/assets/rainbow_wings_1775673904634.webp" },
      { id: "dark_aurora_wings",             name: "Dark Aurora Wings",                 color: "#7c3aed", value: 11,    chance: 5,     rarity: "epic",      imageUrl: "/api/assets/dark_aurora_wings_1775747667384.webp" },
      { id: "zodiac_wings",                  name: "Zodiac Wings",                      color: "#546e7a", value: 14,    chance: 5,     rarity: "epic",      imageUrl: "/api/assets/zodiac_wings_1775542572271.webp" },
      { id: "angel_wings",                   name: "Angel Wings",                       color: "#e0e0e0", value: 17,    chance: 5,     rarity: "epic",      imageUrl: "/api/assets/angelit_1775542339469.webp" },
      { id: "diamond_wings",                 name: "Diamond Wings",                     color: "#80deea", value: 25,    chance: 4,     rarity: "mythic",    imageUrl: "/api/assets/diamond_wings_1775542462005.webp" },
      { id: "devil_wings",                   name: "Devil Wings",                       color: "#c62828", value: 70,    chance: 3,     rarity: "mythic",    imageUrl: "/api/assets/devil_wings_1775542503117.webp" },
      ...
      { id: "bloodmoon_wings",               name: "Bloodmoon Wings",                   color: "#dc2626", value: 250,   chance: 1,     rarity: "legendary", imageUrl: "/api/assets/bloodmoon_wings_1775747771442.webp" },
      { id: "legendary_dragon_knights_wings",name: "Legendary Dragon Knight's Wings",   color: "#dc2626", value: 6500,  chance: 0.1,   rarity: "legendary", imageUrl: "/api/assets/l_drag_wings_1775672007290.webp" },
      { id: "legendary_wings",               name: "Legendary Wings",                   color: "#e2e8f0", value: 9000,  chance: 0.1,   rarity: "legendary", imageUrl: "/api/assets/l_wings_1775671916613.webp" },
      { id: "golden_angel_wings",            name: "Golden Angel Wings",                color: "#ffd600", value: 11000, chance: 0.1,   rarity: "legendary", imageUrl: "/api/assets/gangelit_1775542308015.webp" },
      { id: "nightmare_devil_wings",         name: "Nightmare Devil Wings",             color: "#9c27b0", value: 18000, chance: 0.1,   rarity: "legendary", imageUrl: "/api/assets/ndev_1775521828746.webp" },
    ],
  },
  {
    name: "Starter Pack",
